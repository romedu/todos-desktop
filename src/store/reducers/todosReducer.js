...
import { updateItem, removeById } from "../../utilities/data";
...
const reducer = (prevState = initialState, action) => {
	switch (action.type) {
		case actionTypes.GET_LISTS:
			return { ...prevState, lists: action.lists, paginationData: action.paginationData };

		case actionTypes.CLEAR_LIST:
			return { ...prevState, lists: [], paginationData: initialState.paginationData };

		case actionTypes.OPEN_LIST:
			return { ...prevState, current: action.list };
		...
		case actionTypes.CREATE_LIST:
			return {
				...prevState,
				lists:
					prevState.paginationData.limit > prevState.lists.length
						? prevState.lists.concat(action.newList)
						: prevState.lists,
				paginationData: {
